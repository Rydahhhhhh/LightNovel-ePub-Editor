...
func _ready() -> void:
	...
	print("\nReincarnated as a Sword - Volume 13 [Seven Seas][Kobo].epub")
	book = Epub.new("D:\\My Programs\\Godot\\ln-epub-formatter\\Reincarnated as a Sword - Volume 13 [Seven Seas][Kobo].epub")
